...
\addcontentsline{toc}{subsection}{Monoid}
...
$b = b'$, denn $$b' = e \circ b' = (b\circ a) \circ b' = b \circ (a \circ b') = b \circ e = b$$
 \end{bem*}
\end{defi}
\addcontentsline{toc}{subsection}{Gruppe}
...
\addcontentsline{toc}{subsection}{Ring}
...
\addcontentsline{toc}{subsection}{Erzeuger}
...
\addcontentsline{toc}{subsection}{Zyklische Gruppe}
...
\addcontentsline{toc}{subsection}{Satz von Lagrange}
...
\addcontentsline{toc}{subsection}{Exponent einer Gruppe}
...
\addcontentsline{toc}{subsection}{Homomorphismus}
...
\addcontentsline{toc}{subsection}{Isomorphismus}
...
\begin{proof}[Beweisskizze](Übung)
  ...
  \end{itemize}
\end{proof}
\addcontentsline{toc}{section}{Normalteiler}
...
\addcontentsline{toc}{subsection}{Kommutator/Kommutatoruntergruppe}
\begin{ubng} \item
  \begin{enumerate}[(a)]
...
\end{proof}
\end{satz}
\addcontentsline{toc}{subsection}{Faktor-/Quotientengruppe}
...
\addcontentsline{toc}{section}{Homomorphiesatz für Gruppen}
...
\end{enumerate}
\end{ubng*}
\addcontentsline{toc}{section}{Einschub: Faktorringe}
...
\end{proof}
\end{satz}
\addcontentsline{toc}{section}{Die Isomorphiesätze}
\subsection*{Die Isomorphiesätze}
\addcontentsline{toc}{subsection}{Erster Isomorphiesatz}
...
\addcontentsline{toc}{subsection}{Zweiter Isomorphiesatz}
...
\addcontentsline{toc}{section}{(Semi-)direkte Produkte}
...
\addcontentsline{toc}{subsection}{Semi-direktes Produkt}
