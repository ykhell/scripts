...
\addcontentsline{toc}{subsection}{Satz von Jordan-Hölder}
\begin{satz}[\textbf{Satz von Jordan-Hölder}]
...
\end{whg*}
\end{prop}
\addcontentsline{toc}{subsection}{Abgeleitete Reihe}
\begin{defi}[\textbf{Abgeleitete Reihe}]
...
\addcontentsline{toc}{subsection}{Auflösbarkeitskriterium}
\begin{satz}[\textbf{Auflösbarkeitskriterium}]
...
\addcontentsline{toc}{subsection}{Perfekte Gruppe}
\begin{defi}[\textbf{Perfekte Gruppe}]
  Eine Gruppe $G$ heißt perfekt $\iff G = [G, G] = G^{1}(G)$. Damit (Übung) ist $A_{n}$ perfekt für $n \ge 5$.
  \begin{bem*}[ohne Beweis] $\SLn(K)$ ist perfekt, falls $\#K \notin \{2, 3\}$
  \end{bem*}
\end{defi}
