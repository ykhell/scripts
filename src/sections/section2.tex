...
\begin{satz}[Zykeldarstellung von Permutationen]
...
\begin{defi}[Young-Diagramm/Partition] Sei $\s \in \Sn$, seien $I_{1}, ..., I_{t}$ die Bahnen von $\<\s\>$ (auch Bahnen der Länge $1$), und gelte o.E. $\#I_{1} \ge \#I_{2} \ge \cdots \ge \#I_{t}$.
  \begin{enumerate}[(a)]
...
\end{bsp*}
\begin{defi*}[Signum-Funktion/Alternierende Gruppe]
